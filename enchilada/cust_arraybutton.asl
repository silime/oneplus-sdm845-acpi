Device (BTNS)
{
     ...
     Method (_CRS, 0x0, NotSerialized)
     {
         ...
         {
               //Power Button
              GpioInt (Edge, ActiveBoth, Exclusive, PullDown, 16,"\\_SB.PM01", 0, ResourceConsumer, ,){ 0x0000}

                 // Volume Up button
              GpioInt (Edge, ActiveBoth, ExclusiveAndWake, PullUp, 0,"\\_SB.PM01", 0, ResourceConsumer, ,){0x0085}

                // Volume Down button
              GpioInt (Edge, ActiveBoth, ExclusiveAndWake, PullDown, 0,"\\_SB.PM01", 0, ResourceConsumer, ,){0x0084}
