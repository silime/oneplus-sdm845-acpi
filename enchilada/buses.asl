...
Device (I2C5)
{
    ...
    Method (_CRS, 0x0, NotSerialized)
    {
        Name (RBUF, ResourceTemplate ()
        {
            Memory32Fixed (ReadWrite, 0x890000, 0x00004000)
...
//         Name (RBUF, ResourceTemplate ()
//         {
//             Memory32Fixed (ReadWrite, 0x89c000, 0x00004000)
    ...
    Name(BSRC, Package()
    {
        ...
        Package()
        {
            ...
            Package()
            {
                ...
                // Configure SDA and then SCL
                package() {"TLMMGPIO", package() {89, 1, 1, 1, 3, 0}},
                package() {"TLMMGPIO", package() {90, 1, 1, 1, 3, 0}},
            },
            Package()
            {
                "DSTATE",
            ...
            Package()
            {
                ...
                // Configure SCL and then SDA
                package() { "TLMMGPIO", package() {89, 0, 0, 0, 3, 0}},
                package() { "TLMMGPIO", package() {90, 0, 0, 0, 3, 0}},
            },
        },
        ...
        //         // Configure SDA and then SCL
        //         package() {"TLMMGPIO", package() {93, 1, 1, 1, 3, 0}},
        //         package() {"TLMMGPIO", package() {94, 1, 1, 1, 3, 0}},
        //     },
        //     Package()
        //     {
        //         "DSTATE",
        ...
        //         // Configure SCL and then SDA
        //         package() { "TLMMGPIO", package() {93, 0, 0, 0, 3, 0}},
        //         package() { "TLMMGPIO", package() {94, 0, 0, 0, 3, 0}},
        //     },
        // },
