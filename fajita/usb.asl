...
Device(UCP0)
{
    ...
    Method(CCOT, 0x2, NotSerialized) {
        ...
        // Invoke USB Analog IC event
        // Store(Arg0, \_SB.CCS2)
        // Notify USB Analog IC
...
//         {
//             I2CSerialBus (0x42, , 100000, AddressingMode7Bit, "\\_SB.I2C7",,,,)
//             GpioIo (Shared, PullNone, 0, 0, IoRestrictionNone, "\\_SB.GIO0", 0, ResourceConsumer, , RawDataBuffer(0x1){0x01}) {38} // CC_OUT
//             GpioIo (Exclusive, PullUp, 0, 0, , "\\_SB.PM01", ,) {0x0089} // Enable default GPIO
//         })
//         Return (RBUF)
//     }
// }
